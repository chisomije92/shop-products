...
const MONGOS_OR_UNKNOWN = new Set([ServerType.Mongos, ServerType.Unknown]);
const MONGOS_OR_STANDALONE = new Set([ServerType.Mongos, ServerType.Standalone]);
...
export class TopologyDescription {
    ...
    constructor(topologyType, serverDescriptions, setName, maxSetVersion, maxElectionId, commonWireVersion, options) {
        ...
        this.type = topologyType !== null && topologyType !== void 0 ? topologyType : TopologyType.Unknown;
    ...
    update(serverDescription) {
        ...
        if (topologyType === TopologyType.Single) {
            ...
            return new TopologyDescription(TopologyType.Single, serverDescriptions, setName, maxSetVersion, maxElectionId, commonWireVersion, { heartbeatFrequencyMS: this.heartbeatFrequencyMS, localThresholdMS: this.localThresholdMS });
        }
