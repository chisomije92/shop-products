...
export class MongoCredentials {
    constructor(options) {
        ...
        if ('gssapiCanonicalizeHostName' in this.mechanismProperties) {
            emitWarningOnce('gssapiCanonicalizeHostName is deprecated. Please use CANONICALIZE_HOST_NAME instead.');
    ...
    validate() {
        var _a;
        if ((this.mechanism === AuthMechanism.MONGODB_GSSAPI ||
        ...
        if (AUTH_MECHS_AUTH_SRC_EXTERNAL.has(this.mechanism)) {
            if (this.source != null && this.source !== '$external') {
                ...
                throw new MongoAPIError(`Invalid source '${this.source}' for mechanism '${this.mechanism}' specified.`);
            }
        }
    ...
    static merge(creds, options) {
        ...
        return new MongoCredentials({
            ...
            mechanism: (_f = (_e = options.mechanism) !== null && _e !== void 0 ? _e : creds === null || creds === void 0 ? void 0 : creds.mechanism) !== null && _f !== void 0 ? _f : AuthMechanism.MONGODB_DEFAULT,
