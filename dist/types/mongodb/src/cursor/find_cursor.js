...
import { emitWarningOnce, mergeOptions } from '../utils';
...
export class FindCursor extends AbstractCursor {
    ...
    clone() {
        ...
        return new FindCursor(this.client, this.namespace, this[kFilter], Object.assign({}, clonedOptions));
    }
    map(transform) {
    ...
    _initialize(session, callback) {
        const findOperation = new FindOperation(undefined, this.namespace, this[kFilter], Object.assign(Object.assign(Object.assign({}, this[kBuiltOptions]), this.cursorOptions), { session }));
    ...
    count(options, callback) {
        emitWarningOnce('cursor.count is deprecated and will be removed in the next major version, please use `collection.estimatedDocumentCount` or `collection.countDocuments` instead ');
        ...
        return executeOperation(this.client, new CountOperation(this.namespace, this[kFilter], Object.assign(Object.assign(Object.assign({}, this[kBuiltOptions]), this.cursorOptions), options)), callback);
    }
    explain(verbosity, callback) {
        ...
        if (verbosity == null)
            verbosity = true;
        return executeOperation(this.client, new FindOperation(undefined, this.namespace, this[kFilter], Object.assign(Object.assign(Object.assign({}, this[kBuiltOptions]), this.cursorOptions), { explain: verbosity })), callback);
    }
    ...
    addQueryModifier(name, value) {
        ...
        switch (field) {
            ...
            case 'min':
                ...
                break;
            case 'orderby':
                this[kBuiltOptions].sort = formatSort(value);
                break;
            case 'query':
                this[kFilter] = value;
                break;
