...
export function indexInformation(db, name, _optionsOrCallback, _callback) {
    ...
    if (topology.isDestroyed())
        return callback(new MongoTopologyClosedError());
...
export function prepareDocs(coll, docs, options) {
    var _a;
