...
import { Batch, BatchType, BulkOperationBase } from './common';
/** @public */
export class OrderedBulkOperation extends BulkOperationBase {
    ...
    addToOperationsList(batchType, document) {
        ...
        if (bsonSize >= this.s.maxBsonObjectSize)
            ...
            throw new MongoInvalidArgumentError(`Document is larger than the maximum size ${this.s.maxBsonObjectSize}`);
